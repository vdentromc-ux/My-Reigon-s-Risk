...
const TRANSLATIONS = {
  en: {
    ...
    lp_slogan:'Know your risk. Stay prepared.',
    ...
    lp_no_bs:'No account required · Free forever · Works offline',
  ...
  es: {
    ...
    lp_slogan:'Conoce tu riesgo. Mantente preparado.',
    ...
    lp_no_bs:'Sin cuenta requerida · Gratis para siempre · Funciona sin conexión',
  ...
  fr: {
    ...
    lp_slogan:'Connaissez votre risque. Restez préparé.',
    ...
    lp_no_bs:'Sans compte requis · Gratuit pour toujours · Fonctionne hors ligne',
  ...
  de: {
    ...
    lp_slogan:'Kennen Sie Ihr Risiko. Bleiben Sie vorbereitet.',
    ...
    lp_no_bs:'Kein Konto erforderlich · Kostenlos für immer · Funktioniert offline',
  ...
  zh: {
    ...
    lp_slogan:'了解您的风险，做好备灾准备。',
    lp_sub:'实时灾害数据、个性化风险分析和备灾工具 — 专为您的精确位置定制，完全免费。',
    lp_cta_start:'立即开始 →',
    lp_no_bs:'无需注册 · 永久免费 · 支持离线使用',
